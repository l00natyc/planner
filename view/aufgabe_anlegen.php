...
<html>  
    ...
    <script>
        jQuery(document).on('submit', 'form', function (event) {
            ...
            console.log(data);
            jQuery.ajax({
                url: "aufgabe_anlegen_formdata.php",
                method: 'POST',
                processData: false,
                contentType: false,
                data: data,
    ...
    <body>  
        <div class="container">  
            ...
            <h3 align="center">Neue Aufgabe anlegen</h3>  
            <form action='#' method="post">
                <div class="form-group">
                    <label for="example-datetime-local-input" class="col-2 col-form-label">Aufgabenname</label>
                    <div class="col-10">
